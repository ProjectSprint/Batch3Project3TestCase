// taken from: https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/k6/http/index.d.ts
import type { Selection } from "./k6-html.d.ts";
import type { JSONValue } from "./k6.d.ts";
